      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Nova Works</h3>
            <p className="text-gray-400 mb-4">
              We create exceptional digital experiences that drive results. 
              From brand identity to full-stack development, we're your creative technology partner.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="#" className="hover:text-white">Brand Identity</Link></li>
              <li><Link href="#" className="hover:text-white">Web Design</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Nova Works. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
